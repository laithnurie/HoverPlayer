 ...
 */
package com.sky.hoverplayer.player;
...
public class PlayerActivity extends Activity implements SurfaceHolder.Callback, OnClickListener,
    ...
    public static Intent getPlayerIntent(Context context, String streamUrl, int contentType) {
        return new Intent(context, PlayerActivity.class)
                .setData(Uri.parse(streamUrl))
                .putExtra(PlayerActivity.CONTENT_TYPE_EXTRA, contentType);
    }
